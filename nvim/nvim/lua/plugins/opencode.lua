return {
  ...
  config = function()
    ...
    require("opencode").setup({
      keymap = {
        editor = { -- Cambió de 'global' a 'editor'
          ["<leader>aa"] = { "toggle" },
          ...
          ["<leader>aq"] = { "close" },
          -- ['<leader>af'] = { 'toggle_fullscreen' }, -- ❌ ELIMINAR - ya no existe
          ...
          ["<leader>arA"] = { "diff_revert_all" }, -- Cambió de 'diff_revert_all'
          ["<leader>arT"] = { "diff_revert_this" }, -- Cambió de 'diff_revert_this'
          ["<leader>ax"] = { "swap_position" }, -- ✅ Usar esta en lugar de switch_position
        },
      },
